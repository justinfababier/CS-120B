 ...
 * 
 * Demo Link: https://youtu.be/FFviQ2dDQuw
 */
...
const unsigned long GCD_PERIOD = 2;		// Greatest Common Divisor for task periods
...
const unsigned long SM3_PERIOD = 2;		// Period of state machine 3
